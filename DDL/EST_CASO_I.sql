...
# DROP SCHEMA (remover todas as tabelas)
DROP SCHEMA IF EXISTS EC1_SI1N;

# FASE 1: CRIAR O BANCO DE DADOS (SCHEMA OU DATABASE):
CREATE SCHEMA IF NOT EXISTS EC1_SI1N;
...
# ALTER TABLE - "ALTER TABLE (Nome Tabela) ADD (Nome Coluna) (Tipo) Not null ou não" 
ALTER TABLE FORNECEDORES ADD FORNEC_EMAIL VARCHAR(50) NOT NULL;
ALTER TABLE FILIAIS ADD FILIAL_TELEFONE VARCHAR(15) NOT NULL;
ALTER TABLE PRODUTOS ADD PROD_DATAFAB DATE;
ALTER TABLE PEDIDOS ADD PED_DATA_CONCLUSAO DATE;
ALTER TABLE RECEBIMENTOS ADD RECEB_OBSERVACOES TEXT;
ALTER TABLE PEDIDOS_PRODUTOS ADD PDPR_PRECO_TOTAL DECIMAL(10,2) NOT NULL;
ALTER TABLE FILIAIS_PRODUTOS ADD FLPR_DATA_ATUALIZACAO DATE;
ALTER TABLE FORNECEDORES_PRODUTOS ADD FRPR_DATA_FORNECIMENTO DATE;
  
ALTER TABLE PRODUTOS ADD PROD_COR varchar(100);
