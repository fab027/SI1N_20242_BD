...
CREATE TABLE IF NOT EXISTS VOOS (
  ...
  CONSTRAINT FK_AEROPORTO_ORI FOREIGN KEY(AEROPORTO_ORIGEM) REFERENCES AEROPORTOS(AEROPORTO_COD),
  CONSTRAINT FK_AEROPORTO_DEST FOREIGN KEY(AEROPORTO_DESTINO) REFERENCES AEROPORTOS(AEROPORTO_COD)
